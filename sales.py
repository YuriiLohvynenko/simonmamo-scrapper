...
def sales_info(url, page_name):
    ...
    f = open("sales/"+page_name, "w+", encoding='utf-8')
    f.write(str(soup))
    f.close()
...
for i in range(1, 166):
    sales_url = 'https://www.simonmamo.com/en/property-forsale/webshop/search/item/modified_date/desc/20/' + str(i) + '.htm?region=Select&as-minp=0&as-maxp=&beds=&condition='
    page_name = "sales" + str(i) +".html"
    sales_info(sales_url, page_name)
